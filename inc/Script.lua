...
return  "-«** أهلا يقلبي "..msg.TheRankCmd.."\n-«** تم تعطيل الايدي بالصوره  \n" 
end 
...
return sendMsg(msg.chat_id_,msg.id_,"-«**ً أهلا يقلبي "..msg.TheRankCmd.." \n-«** تم تثبيت الرساله \n✓")
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"-«**ًأهلا يقلبي "..msg.TheRankCmd.."  \n-«** تم الغاء تثبيت الرساله \n")    
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'-«**-عذراً لا يمكنني الغاء التثبيت .\n-«** لست مشرف او لا املك صلاحيه التثبيت \n')    
elseif data.ID == "Error" and data.code_ == 400 then
return sendMsg(msg.chat_id_,msg.id_,'-«** ًعذرا يقلبي '..msg.TheRankCmd..' .\n-«** لا توجد رساله مثبته لاقوم بازالتها \n')    
end
end,nil)
end
return false
...
sendMsg(msg.chat_id_,msg.id_,"-«** أهلا يقلبي "..msg.TheRankCmd.."\n-«** الرفع معطل \n")
end
return false
end
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/moatazkhaledd/mo3tazfile/master/GetVersion.txt' ) or 0
...
return '-اصدار سورس أرماندو : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'-«** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس مِـيـلَان يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قناة‏‏آلسـورس اضـغـط هـنـآ ",url="http://t.me/SouurceLink"}}}
send_key(msg.sender_user_id_,'   [قناة السورس : بيتر ](http://t.me/SouurceLink)' ,nil,inline,msg.id_)
return false
end
...
return [[
[• مـطـور الـسـورس](http://t.me/IIIZIIII)  .
[• بوت الـسـورس](http://t.me/Gak02Bot)  .
[• قرأن](http://t.me/EEl00)  .
[• قـنـاة الـسـورس](http://t.me/SouurceLink)  .
]]
end
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "مرحبا"  then return sendMsg(msg.chat_id_,msg.id_,"اهلاً يقلبي .")
  ...
  elseif Text== "هلو" or Text== "هاي." or Text== "هاي" then return sendMsg(msg.chat_id_,msg.id_,"اجمل هاي .")
 ...
 elseif Text== "مساعدة"  then return sendMsg(msg.chat_id_,msg.id_,"لعرض قائمة المساعدة اكتب الاوامر 🌚❤️")
  ...
  elseif Text== "حبيبي" or Text=="حبي" then return  sendMsg(msg.chat_id_,msg.id_,"بحبك")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](http://t.me/SouurceLink) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](http://t.me/SouurceLink)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](http://t.me/SouurceLink)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](http://t.me/SouurceLink)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](http://t.me/SouurceLink)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](http://t.me/SouurceLink) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](http://t.me/SouurceLink)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](http://t.me/SouurceLink)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](http://t.me/SouurceLink)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](http://t.me/SouurceLink)")
