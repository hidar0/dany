...
if MsgText[1] == 'الالغاز' or MsgText[1] == 'لغز' then
  ...
  name = katu[math.random(#katu)]
  redis:set(dany..':Set_lgz:'..msg.chat_id_,name)
...
return 'اول من يكتب ذي يفوز ⬅︎`'..(redis:get(dany..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب ذي يفوز ⬅︎    `'..(redis:get(dany..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
return [[ 
• الgames لبوت []]..redis:get(dany..':NameBot:')..[[]🎖.
↓ ↓ ↓ ↓ 
•  امثله .
•  معاني .
•  اسئله .
...
if MsgText[1] == 'قائمه الgames' then
...
if msg.text == redis:get(dany..':Set_lgz:'..msg.chat_id_) then -- // لغز
redis:incrby(dany..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(dany..':Set_lgz:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت اللغز   \n*   \n')
end

if msg.text == redis:get(dany..':Set_lgz:'..msg.chat_id_) then -- // الالغاز
redis:incrby(dany..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(dany..':Set_lgz:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت اللغز   \n*   \n')
end

if msg.text == redis:get(dany..':Set_Amthlh:'..msg.chat_id_) then -- // رياضيات
redis:incrby(dany..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(dany..':Set_Amthlh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت المسائله الصحيحه   \n*   \n')
end

if msg.text == redis:get(dany..':Set_Amthlh:'..msg.chat_id_) then -- // تركيب
redis:incrby(dany..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(dany..':Set_Amthlh:'..msg.chat_id_)
