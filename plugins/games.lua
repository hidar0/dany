--[[
الالعاب ل سورس داني
تم تعديل الملف واضافه الالعاب من قبل سونيك (@UU_iv)
--]]
...
الالعاب ل سورس دانـي
تم تعديل الملف واضافه الالعاب من قبل سـونـيـكᐂ (UU_IV)
--]]
local function games(msg,MsgText)
if msg.type ~= "pv" then
if MsgText[1] == "تفعيل" and MsgText[2] == "الالعاب" or MsgText[2] == "اللعبه" or MsgText[2] == "اللعبة" then
...
redis:set(dany..':Set_Smile:'..msg.chat_id_,Emoji)
if tonumber(redis:get(dany..':Set_Smile:'..msg.chat_id_)) == tonumber(redis:get(dany..':NUM_SET:'..msg.chat_id_)) then
return '•اول من يكتب هذا العدد يفوز  ››`'..(redis:get(dany..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️•اول من يكتب هذا الشكل يفوز ››    `'..(redis:get(dany..':Set_Smile:'..msg.chat_id_))..'`'
end
end
if MsgText[1] == 'ترتيب' then
katu = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
